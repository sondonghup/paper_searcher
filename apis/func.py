...
class chatgpt_func():
    ...
    #     self.textrank = self.textrank(self.okt.phrases(text))
    #     return self.textrank.summarize(text, k , verbose = False)
    ...
    def preprocess(self, text):
        ...
        # print('길이', len(self.summarized_text))
    ...
    def translate_func(self, text):
        ...
        # self.summarized_text, _ = self.preprocess(text)
...
if __name__ == "__main__":
    ...
    # print(summarize(input, language='english', ratio=0.3, split=True))
